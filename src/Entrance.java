...
public class Entrance {
    ...
    public void logIn() {
        ...
        /*
        declaring tasks of level from file missions.txt
        file format:
 ...
 */
        //level1
        Task taskOfLevel1=new Task(1,50,60,400,300,200);
        ...
        //level2
        Task taskOfLevel2=new Task(2,70,90,500,300,350);
        ...
        //level3
        Task taskOfLevel3=new Task(3,90,110,600,700,400);
        ...
        taskOfLevel3.neededCommodity.put("icevream",5);
          //level4
        Task taskOfLevel4=new Task(4,110,150,800,850,500);
        ...
        //level5
        Task taskOfLevel5=new Task(5,150,200,1000,850,750);
