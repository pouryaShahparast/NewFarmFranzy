...
import model.factories.FabricProduction;
import model.factories.Factory;

public class FabricProductionPanel extends AbstractFactoryPanel{
    public FabricProductionPanel(int x, int y) {
        super(x, y);
    }

    @Override
    public void init() {
        factoryNameOrImage.setText("fabric");
    }
    ...
    public boolean build() {
        ...
        if (!found) {
            return FabricProduction.buildFabricProduction(coin);
