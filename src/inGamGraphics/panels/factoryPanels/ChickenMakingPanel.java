...
import model.factories.ChickenMakingFactory;
import model.factories.Factory;

public class ChickenMakingPanel extends AbstractFactoryPanel{
    public ChickenMakingPanel(int x, int y) {
        super(x, y);
    }

    @Override
    public void init() {
        factoryNameOrImage.setText("chickenMaking");
    }
    ...
    public boolean build() {
        ...
        for (Factory factory :
            ...
            if (factory instanceof ChickenMakingFactory) {
                found = true;
        ...
        if (!found) {
            return ChickenMakingFactory.buildChickenMakingFactory(coin);
