...
import model.factories.Mill;

public class MillPanel extends AbstractFactoryPanel{
    public MillPanel(int x, int y) {
        super(x, y);
    }

    @Override
    public void init() {
        factoryNameOrImage.setText("mill");
    }
