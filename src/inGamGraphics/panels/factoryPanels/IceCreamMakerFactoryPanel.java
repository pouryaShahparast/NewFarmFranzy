...
import model.factories.IceCreamMaker;

public class IceCreamMakerFactoryPanel extends AbstractFactoryPanel{
    public IceCreamMakerFactoryPanel(int x, int y) {
        super(x, y);
    }

    @Override
    public void init() {
        factoryNameOrImage.setText("iceCream");
    }
    ...
    public boolean build() {
        ...
        if (!found) {
            return IceCreamMaker.buildIceCreamMaker(coin);
